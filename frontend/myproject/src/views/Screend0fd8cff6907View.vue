...
<div class="wrapper-a0edc6cf4ff0" data-x="20" data-y="20" style="max-height:106px; transform:translate(20px, 20px); max-width:1006px; min-height:36px; position:absolute; min-width:106px; ">
  <h3 class="sub-tit10" style="background-color:#ffffff; color:#000000; width:1000px; font-size:20px; line-height:50px; border-width:1px; border-color:#000000; border-style:none; border-bottom:2px solid #fca501; height:50px; ">구매상품 조회</h3>
</div>
<div class="wrapper-a326ade34fa4" data-x="925" data-y="450" style="max-height:100px; transform:translate(925px, 450px); max-width:200px; min-height:36px; position:absolute; min-width:26px; ">
...
<div class="wrapper-a72e18dabd70" data-x="20" data-y="200" style="max-height:106px; transform:translate(20px, 200px); max-width:906px; min-height:36px; position:absolute; min-width:56px; ">
...
<div class="wrapper-a764c714aac1" data-x="170" data-y="150" style="max-height:56px; transform:translate(170px, 150px); max-width:506px; min-height:26px; position:absolute; min-width:56px; ">
  <input :value="reftbe18ac518df06fbe62f2dd314Dto.a9cbd6338b24"  readonly type="text"  class="input_10_i"  data-data-storage-column-id="a9cbd6338b24"  style="border-right-style:unset; max-height:50px; font-size:12px; min-height:20px; border-bottom:1px solid #bebebe; border-top-style:unset; border-radius:unset; background-color:#ffffff; max-width:500px; border-left-style:unset; width:850px; height:30px; min-width:50px; "/>
</div>
<div class="wrapper-b523478b081a" data-x="170" data-y="250" style="max-height:56px; transform:translate(170px, 250px); max-width:506px; min-height:26px; position:absolute; min-width:56px; ">
  <input :value="reftbe18ac518df06fbe62f2dd314Dto.a9480a0be018"  readonly type="text"  class="input_10_i"  data-data-storage-column-id="a9480a0be018"  style="border-right-style:unset; max-height:50px; font-size:12px; min-height:20px; border-bottom:1px solid #bebebe; border-top-style:unset; border-radius:unset; background-color:#ffffff; max-width:500px; border-left-style:unset; width:850px; height:30px; min-width:50px; "/>
</div>
<div class="wrapper-b8a40afa82d4" data-x="20" data-y="100" style="max-height:106px; transform:translate(20px, 100px); max-width:906px; min-height:36px; position:absolute; min-width:56px; ">
...
<div class="wrapper-d19c3157433c" data-x="20" data-y="250" style="max-height:106px; transform:translate(20px, 250px); max-width:906px; min-height:36px; position:absolute; min-width:56px; ">
...
<div class="wrapper-d922b808f3f2" data-x="170" data-y="100" style="max-height:56px; transform:translate(170px, 100px); max-width:506px; min-height:26px; position:absolute; min-width:56px; ">
  <input :value="reftbe18ac518df06fbe62f2dd314Dto.ec9013607471"  readonly type="text"  class="input_10_i"  data-data-storage-column-id="ec9013607471"  style="border-right-style:unset; max-height:50px; font-size:12px; min-height:20px; border-bottom:1px solid #bebebe; border-top-style:unset; border-radius:unset; background-color:#ffffff; max-width:500px; border-left-style:unset; width:850px; height:30px; min-width:50px; "/>
</div>
<div class="wrapper-dcf998a47eaf" data-x="815" data-y="450" style="max-height:100px; transform:translate(815px, 450px); max-width:200px; min-height:36px; position:absolute; min-width:26px; ">
  <button type="button" class="btn1010" @click="buttonAction('None', 'a4bc85889c8d')" data-next-scren-id="a4bc85889c8d" data-button-action="None" style="max-height:100px; color:#ffffff; font-weight:normal; font-size:15px; min-height:30px; border-color:#f07009; background-color:rgba(252, 165, 1, 1); border-radius:unset; max-width:200px; width:104px; border-width:1px; border-style:solid; height:40px; min-width:20px; ">수정</button>
</div>
<div class="wrapper-eb2e66545809" data-x="20" data-y="150" style="max-height:106px; transform:translate(20px, 150px); max-width:906px; min-height:36px; position:absolute; min-width:56px; ">
...
<div class="wrapper-f2f273a6159f" data-x="170" data-y="200" style="max-height:56px; transform:translate(170px, 200px); max-width:506px; min-height:26px; position:absolute; min-width:56px; ">
  <input :value="reftbe18ac518df06fbe62f2dd314Dto.f49d7f97577a"  readonly type="text"  class="input_10_i"  data-data-storage-column-id="f49d7f97577a"  style="border-right-style:unset; max-height:50px; font-size:12px; min-height:20px; border-bottom:1px solid #bebebe; border-top-style:unset; border-radius:unset; background-color:#ffffff; max-width:500px; border-left-style:unset; width:850px; height:30px; min-width:50px; "/>
</div>
          </div>
        </div>
      </div>
