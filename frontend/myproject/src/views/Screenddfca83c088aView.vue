...
<form method="post" style="">
  <div class="wrapper-b5e8d20dbbb1" data-x="815" data-y="450" style="max-height:100px; transform:translate(815px, 450px); max-width:200px; min-height:36px; position:absolute; min-width:26px; ">
  <button type="button" class="btn1010" @click="buttonAction('C', 'd0fd8cff6907')" data-next-scren-id="d0fd8cff6907" data-button-action="C" style="max-height:100px; color:#ffffff; font-weight:normal; font-size:15px; min-height:30px; border-color:#f07009; background-color:rgba(252, 165, 1, 1); border-radius:unset; max-width:200px; width:104px; border-width:1px; border-style:solid; height:40px; min-width:20px; ">등록</button>
</div>
  <div class="wrapper-b8bd249372d6" data-x="20" data-y="20" style="max-height:106px; transform:translate(20px, 20px); max-width:1006px; min-height:36px; position:absolute; min-width:106px; ">
  <h3 class="sub-tit10" style="background-color:#ffffff; color:#000000; width:1000px; font-size:20px; line-height:50px; border-width:1px; border-color:#000000; border-style:none; border-bottom:2px solid #fca501; height:50px; ">구매상품 등록</h3>
</div>
  <div class="wrapper-c09b80ff42d5" data-x="925" data-y="450" style="max-height:100px; transform:translate(925px, 450px); max-width:200px; min-height:36px; position:absolute; min-width:26px; ">
  ...
  <div class="wrapper-c7f44a3f50ed" data-x="20" data-y="150" style="max-height:106px; transform:translate(20px, 150px); max-width:906px; min-height:36px; position:absolute; min-width:56px; ">
  ...
  <div class="wrapper-d501272c65eb" data-x="20" data-y="200" style="max-height:106px; transform:translate(20px, 200px); max-width:906px; min-height:36px; position:absolute; min-width:56px; ">
  ...
  <div class="wrapper-e2a0760eba96" data-x="170" data-y="150" style="max-height:56px; transform:translate(170px, 150px); max-width:506px; min-height:26px; position:absolute; min-width:56px; ">
  ...
  <div class="wrapper-e3f3f2fe5d43" data-x="170" data-y="100" style="max-height:56px; transform:translate(170px, 100px); max-width:506px; min-height:26px; position:absolute; min-width:56px; ">
  ...
  <div class="wrapper-e4a3f1bb9c7b" data-x="170" data-y="200" style="max-height:56px; transform:translate(170px, 200px); max-width:506px; min-height:26px; position:absolute; min-width:56px; ">
  ...
  <div class="wrapper-e5af7912951a" data-x="170" data-y="250" style="max-height:56px; transform:translate(170px, 250px); max-width:506px; min-height:26px; position:absolute; min-width:56px; ">
  ...
  <div class="wrapper-fcd35e5a5cd0" data-x="20" data-y="100" style="max-height:106px; transform:translate(20px, 100px); max-width:906px; min-height:36px; position:absolute; min-width:56px; ">
  ...
  <div class="wrapper-fe35fb33fd27" data-x="20" data-y="250" style="max-height:106px; transform:translate(20px, 250px); max-width:906px; min-height:36px; position:absolute; min-width:56px; ">
